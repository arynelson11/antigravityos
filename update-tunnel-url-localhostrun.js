...
const newUrl = 'https://d79e165ca5be51.lhr.life/api/n8n'; // Updated with localhost.run URL
...
(async () => {
    try {
        ...
        console.log('Sending Localhost Run URL update to n8n...');
        ...
        if (updateRes.ok) {
            console.log('✅ Tools updated with new Tunnel URL (Localhost Run)!');
        } else {
