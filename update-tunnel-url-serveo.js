...
// NEW URL FROM SERVEO OUTPUT
const newUrl = 'https://4f4d884ab40b7e90-168-197-238-182.serveo.net/api/n8n';
...
(async () => {
    try {
        ...
        console.log('Sending Serveo URL update to n8n...');
        ...
        if (updateRes.ok) {
            console.log('✅ Tools updated with new Tunnel URL (Serveo)!');
        } else {
